...
# Optimized for a responsive three-message system with concurrent background updates.
...
class LootControlView(nextcord.ui.View):
    ...
    def _add_components(self):
        """Adds the necessary components for the current phase of the loot session."""
...
async def _update_all_messages(session_id: int, interaction: nextcord.Interaction):
    ...
    Optimized to create the new UI message first for a snappy user experience.
    """
    ...
    session["ui_message_id"] = new_ui_msg.id if new_ui_msg else None
